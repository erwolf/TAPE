...
Year.create(year_id:2020,plan_id:"1")
Year.create(year_id:2021,plan_id:"1")
Year.create(year_id:2022,plan_id:"1")
Year.create(year_id:2023,plan_id:"1")
Year.create(year_id:2018,plan_id:"1")
Year.create(year_id:2019,plan_id:"1")
Year.create(year_id:2017,plan_id:"1")
Year.create(year_id:2016,plan_id:"1")
Year.create(year_id:2016,plan_id:"2")


Semester.create(term:"Spring",year_id:2021)
Semester.create(term:"Fall",year_id:2021)
Semester.create(term:"Fall",year_id:2020)
Semester.create(term:"Spring",year_id:2022)
Semester.create(term:"Fall",year_id:2022)
Semester.create(term:"Spring",year_id:2023)
Semester.create(term:"Fall",year_id:2023)
Semester.create(term:"Spring",year_id:2024)
